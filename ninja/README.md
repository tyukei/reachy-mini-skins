# Reachy Mini removable ninja skin
...
.venv/bin/python ninja/generate_ninja_skin.py --clearance 1.5
```
...
`ninja/generate_ninja_skin.py` is the editable parametric source. It exports only manifold, watertight meshes and stops if validation fails.
...
./view-stl.sh ninja/stl/reachy_mini_ninja_torso_front.stl
```
